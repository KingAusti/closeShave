    ...
    def _parse_results(self, soup: BeautifulSoup, max_results: int) -> List[Product]:
        ...
        for container in containers:
            try:
                ...
                # Price
                price_elem = container.select_one(self.selectors.get("price", ".a-price .a-offscreen"))
                ...
                # Availability
                availability_elem = container.select_one(self.selectors.get("availability", ".a-color-state, .a-color-success"))
